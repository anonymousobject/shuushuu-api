...
class TagHistoryResponse(BaseModel):
    ...
    # "Added" events can be derived from tag_links, which carry who/when for tags
    # set at upload that were never written to tag_history. Those synthesized
    # events have no tag_history row, so the id is nullable.
    tag_history_id: int | None = None
