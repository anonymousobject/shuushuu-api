...
USER_WITH_GROUPS_OPTIONS = (selectinload(Users.user_groups).selectinload(UserGroups.group),)
...
def user_with_groups_options():
    ...
    """
    return (selectinload(Users.user_groups).selectinload(UserGroups.group),)
