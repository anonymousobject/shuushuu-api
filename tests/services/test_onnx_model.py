...
class TestWDTaggerPreprocessing:
    ...
    def test_output_shape(self, tmp_path: pytest.fixture) -> None:
    ...
    def test_output_dtype_float32(self, tmp_path: pytest.fixture) -> None:
    ...
    def test_value_range_0_255(self, tmp_path: pytest.fixture) -> None:
    ...
    def test_bgr_channel_order_solid_red(self, tmp_path: pytest.fixture) -> None:
