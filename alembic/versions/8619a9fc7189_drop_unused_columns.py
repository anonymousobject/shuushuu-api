...
def downgrade() -> None:
    ...
    op.add_column('users', sa.Column('infected', sa.Integer(), nullable=True, server_default='0'))
    op.add_column('users', sa.Column('infected_by', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('users', sa.Column('date_infected', sa.Integer(), nullable=False, server_default='0'))
